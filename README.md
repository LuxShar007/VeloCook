...
```mermaid
graph TD
    A[React Client - MacroByte] -->|HTTP POST Plan Request| B[FastAPI Server:8000]
...
MacroByte utilizes a premium dark-mode consulting report aesthetic:
...
- **Heartbeat Verification:** On page load, MacroByte queries the API server. An status indicator badge in the header shows whether the client is connected to the live API or using local simulations.
